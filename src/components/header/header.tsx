...
const Header: FC<HeaderProps> = ({ className }) => {
    return (
        <header className={`text-primary font-body font-normal py-5 w-full absolute min-w-0 top-0 left-0 transition-all ease-in duration-[0.4s] animate-positionAnim ${className}`}>
